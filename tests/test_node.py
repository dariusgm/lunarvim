...
def test_npm():
    # 9.5.1
    output = str(subprocess.check_output('npm --version', shell=True), encoding='utf8').strip()
...
def test_npm_packages():
    ...
    output = str(subprocess.check_output('npm -g ls', shell=True), encoding='utf8').strip()
    packages = {
        'aws-cdk':'2.87.0',
        'corepack':'0.17.0',
        'neovim':'4.10.1',
