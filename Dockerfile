...
# Treesitter
RUN lvim --headless +'TSInstallSync lua query markdown_inline comment regex vim vimdoc ini python gitignore dockerfile markdown yaml toml rust html json' +qall
